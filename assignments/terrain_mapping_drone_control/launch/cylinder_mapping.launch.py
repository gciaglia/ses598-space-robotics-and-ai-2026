...
def generate_launch_description():
    ...
    # RTAB-Map needs a TF chain from odom to camera. PX4/Gazebo doesn't publish TF to ROS2,
    # so we provide static transforms manually.
    static_tf_odom = Node(
        package='tf2_ros',
    ...
    # Camera is mounted at (0.12, 0.03, 0.242) on the x500_depth_mono drone body.
